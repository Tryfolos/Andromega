///// This code runs from within "game_over_logic_draw.c" file /////

//This code will reset the neccesary values so that you can reset the game.
...
f = 0;
while (f < 100) { //Resetting all shielder enemies.
...
f = 0;
while (f < 1000) { //Resetting all pickups.
...
//Setting game music to slow and resetting it.
if (al_get_sample_instance_playing(array_sample_instance[131]) == 1) {
music_speed_change = 0;
music_speed = 1.0;
al_set_sample_instance_position(array_sample_instance[131], 0);
}
